...
<Steps>
  ...
  <Step title="Step 3: Counter-Signing Complete">
    - When **both parties have signed **(counter-signed)
    - leasestatus changes **Renewing -\> Future**
    - Resident status changes from **Current -\> Future Resident**
    - Lease Charge Config (LLC) becomes Active
  </Step>
  <Step title="Step 4: Lease Start">
    - When lease start date arrives
    - Lease status changes **Future -\> Current**
    - Resident status changes **Future Resident -\> Current**
  </Step>
</Steps>
...
| ------------------ | ----------------------------------------- |
| Currently Leased   | Current, Renewing, Notice, Under Eviction |
| Future Lease       | Future                                    |
