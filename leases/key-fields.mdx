...
This documentation explains the business logic and key field meanings for the EliseAI Leasing API. It focuses on understanding the data returned by the `/v2/leases/properties/{property_id}/leases` endpoint and the logic behind fields like statuses values and dates. You'll find information on:
